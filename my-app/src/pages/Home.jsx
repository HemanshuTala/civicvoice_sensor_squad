...
  },[])
  ...
  const slides = [
    { src: "https://picsum.photos/seed/img1/600/400", alt: "Image 1" },
    { src: "https://picsum.photos/seed/img2/600/400", alt: "Image 2" },
    { src: "https://picsum.photos/seed/img3/600/400", alt: "Image 3" },
     { src: "https://picsum.photos/seed/img3/600/400", alt: "Image 3" },
  ];
  const teamData = [
    {
  ...
  <div className="text-center mb-16">
    {/* Animated Heading */}
    <motion.h2
      className="text-4xl font-bold mb-6 text-gray-800 text-center relative"
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 px-4">
    ...
    >
      ...
      <p className="text-4xl font-extrabold text-green-800 mt-2">{stats.completed}</p>
    </motion.div>
    ...
    >
      ...
      <p className="text-4xl font-extrabold text-yellow-800 mt-2">{stats.pending}</p>
    </motion.div>
    ...
    >
      ...
      <p className="text-4xl font-extrabold text-red-800 mt-2">{stats.total}</p>
    </motion.div>
  </div>
</section>

<motion.section
  className="mt-16 px-6 py-16 w-full"
  initial={{ opacity: 0 }}
  animate={{ opacity: 1 }}
...
>
  {/* Section Title */}
  <motion.h2
    className="text-4xl font-bold mb-8 text-gray-800 text-center relative"
    initial={{ y: -50, opacity: 0 }}
    animate={{ y: 0, opacity: 1 }}
    transition={{ duration: 1, delay: 0.2 }}
  >
    Months vs Problems
    <motion.div
      className="absolute w-32 h-1 bg-green-500 left-1/2 transform -translate-x-1/2 mt-3"
      initial={{ scaleX: 0 }}
      animate={{ scaleX: 1 }}
      transition={{ duration: 0.8, delay: 0.4, ease: "easeInOut" }}
    ></motion.div>
  ...
  >
    ...
    >
      ...
      <div className="relative">
        {/* Timeline Line */}
        <motion.div
          className="absolute left-1/2 transform -translate-x-1/2 h-full w-1 bg-gradient-to-b from-green-400 to-blue-400"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1, delay: 0.5 }}
        ></motion.div>
        ...
        <div className="grid grid-cols-1 gap-16 relative">
          ...
          >
            <div className="w-1/2 text-right pr-8">
              <motion.p
                className="text-lg font-medium text-gray-700 group-hover:text-green-600 transition duration-700 delay-200"
                whileHover={{ scale: 1.05 }}
              >
            ...
            <div className="relative group-hover:animate-bounce">
              <motion.div
                className="w-16 h-16 flex items-center justify-center rounded-full bg-green-200 text-green-700 text-2xl font-extrabold shadow-lg group-hover:scale-110 transition duration-700"
          ...
          >
            <div className="w-1/2 text-left pl-8">
              <motion.p
                className="text-lg font-medium text-gray-700 group-hover:text-blue-600 transition duration-700 delay-300"
                whileHover={{ scale: 1.05 }}
              >
            ...
            <div className="relative group-hover:animate-bounce">
              <motion.div
                className="w-16 h-16 flex items-center justify-center rounded-full bg-blue-200 text-blue-700 text-2xl font-extrabold shadow-lg group-hover:scale-110 transition duration-700"
                whileHover={{ scale: 1.2 }}
              >
                2
              </motion.div>
          ...
          >
            <div className="w-1/2 text-right pr-8">
              <motion.p
                className="text-lg font-medium text-gray-700 group-hover:text-yellow-600 transition duration-700 delay-400"
                whileHover={{ scale: 1.05 }}
              >
            ...
            <div className="relative group-hover:animate-bounce">
              <motion.div
                className="w-16 h-16 flex items-center justify-center rounded-full bg-yellow-200 text-yellow-700 text-2xl font-extrabold shadow-lg group-hover:scale-110 transition duration-700"
                whileHover={{ scale: 1.2 }}
              >
                3
              </motion.div>
          ...
          >
            <div className="w-1/2 text-left pl-8">
              <motion.p
                className="text-lg font-medium text-gray-700 group-hover:text-red-600 transition duration-700 delay-500"
                whileHover={{ scale: 1.05 }}
              >
            ...
            <div className="relative group-hover:animate-bounce">
              <motion.div
                className="w-16 h-16 flex items-center justify-center rounded-full bg-red-200 text-red-700 text-2xl font-extrabold shadow-lg group-hover:scale-110 transition duration-700"
                whileHover={{ scale: 1.2 }}
              >
                4
              </motion.div>
