  ...
  return (
    <>
      ...
      >
        ...
        <h1 className="text-3xl font-bold text-gray-800 text-center mb-6 relative">
        Create Complaint
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-gray-800 bg-white shadow-sm transition duration-300 ease-in-out hover:bg-gray-50"
                required
              >
